...
public:
    ...
    static const std::string INDIRECT_FREEKICK_OUR_FORMATION_NEX_CONF;
...
private:
    ...
    rcsc::Formation::Ptr M_indirect_freekick_our_formation_nex;
...
public:
    ...
    static SituationType getSitu(const rcsc::WorldModel & wm );
};
